...
public class UserUseCaseImpl implements UserUseCase {
    ...
    @Override
    public User saveNewRequest(UserCreationRequest request) throws Exception {
        if(
                request == null ||
        ...
        if(optionalExistingUser.isPresent()){
            ...
            throw new Exception("User with email " + request.getEmail() + " and name " + request.getUserName() + " already exists");
        }
